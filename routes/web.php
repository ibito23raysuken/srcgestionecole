...
Route::put('demandes/{demande}', [AvanceDemandeController::class, 'update'])->name('demande.update');
...
Route::get('notes/{exam}/{eleve}', [NoteController::class, 'showAllNote'])->name('notes.showAllNote');
Route::delete('notes/{note}', [NoteController::class, 'destroy'])->name('notes.destroy');
Route::put('notes/{note}', [NoteController::class, 'update'])->name('notes.edit');
Route::get('exams/{exam}', [NoteController::class, 'showAllNoteIdexam'])->name('notes.showAllNote');
